import { AnimationBuilder, AnimationMetadata, AnimationPlayer, animate, query, sequence, stagger, style } from "@angular/animations";

export const ANIMATE_ELEM = 'animate-elem';

const easeOutCubic = 'cubc-bezier(0.33, 1, 0.68, 1)';
